                                ...
                                {tableData.map((row, index) => (
                                    <>
                                        <tr key={index} style={{ borderTop: "1px solid #dee2e6" }}>
                                            <td style={{ minWidth: '100px', paddingTop: "12px", paddingBottom: "12px" }}>{row.date}</td>
                                            <td
                                                style={{ minWidth: '110px', cursor: "pointer", color: "#0d6efd", textDecoration: "underline" }}
                                                onClick={() => openBillModal(row)}
                                            >
                                                {row.billNumber}
                                            </td>
                                            <td
                                                style={{ minWidth: '160px', cursor: "pointer", color: "#0d6efd", textDecoration: "underline" }}
                                            ...
                                            <td style={{ minWidth: '105px', paddingTop: "12px", paddingBottom: "12px" }}>{row.totalItems}</td>
                                            <td
                                                style={{ minWidth: '150px', cursor: "pointer", color: "#0d6efd", textDecoration: "underline" }}
                                                onClick={() => openRAModal(row)}
                                            >
                                                {row.receivedAmount}
                                            </td>
                                            <td style={{ minWidth: '165px', paddingTop: "12px", paddingBottom: "12px" }}>{row.remainingAmount}</td>
                                            <td
                                                style={{ minWidth: '450px', cursor: "pointer", color: "#0d6efd", textDecoration: "underline" }}
                                                                    ...
                                                                    <tr key={prodIndex}>
                                                                        <td>
                                                                            <input
                                                                                ...
                                                                                onChange={() => handleSelect(prodRow.id)}
                                                                            />
                                                                        </td>
                                                                        <td style={{ minWidth: '110px' }}>{prodRow.productSku}</td>
                                                                        <td style={{ minWidth: '200px' }}>{prodRow.lensSku}</td>
                                                                        <td style={{ minWidth: '70px' }}>{prodRow.status}</td>
                                                                    </tr>
                                                                ))}
                                                            </tbody>
                                                        </table>
