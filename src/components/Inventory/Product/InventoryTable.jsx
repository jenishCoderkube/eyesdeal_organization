...
const InventoryTable = ({ data }) => {
  ...
  // Dummy product data with photos
    ...
    () => [
      {
        ...
        barcode: "616570",
        photos: [
          "https://s3.ap-south-1.amazonaws.com/eyesdeal.blinklinksolutions.com/eyesdeal/FRAMES/IGOG KIDS FRAME/616570_1.JPEG",
          "https://s3.ap-south-1.amazonaws.com/eyesdeal.blinklinksolutions.com/eyesdeal/FRAMES/IGOG KIDS FRAME/616570_2.JPEG",
        ],
        sku: "IG-FR-KIDS-2305-C2",
        mrp: 870,
        stock: 0,
        sold: 0,
      },
