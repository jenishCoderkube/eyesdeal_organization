...
function PrescriptionModel({ closePrescriptionModel, activeStatus, selectedCust }) {
            ...
            >
                <div className="modal-content border-0">
                    <div className="modal-header border-bottom pb-2">
                        ...
                        <button type="button" className="btn-close small" onClick={closePrescriptionModel} aria-label="Close"></button>
                    </div>
                                        ...
                                        <div className="px-3 pb-4">
                                            ...
                                            <div className="row g-3 mb-3">
                                                <div className="col-6 col-md-3">
                                                    ...
                                                    <input type="text" id="date" value={formatDate(activeCustomer.updatedAt)} className="form-control bg-white" disabled />
                                                </div>
                                                <div className="col-6 col-md-3">
                                                    {activeStatus === "New Order" ? (
                                                        <>
                                                            <label htmlFor="employeename" className="form-label  mb-0">
                                                                Employee  Name
                                                            </label>
                                                            <input type="text" id="employeename" className="form-control bg-white" disabled />
                                                        </>
                                                    ) : (
                                                        <>
                                                            <label htmlFor="doctorname" className="form-label  mb-0">
                                                                Doctor Name
                                                            </label>
                                                            <input type="text" id="doctorname" className="form-control bg-white" disabled />
                                                        </>
                                                    )}
                                                ...
                                                <div className="col-6 col-md-3">
                                                    ...
                                                    <input type="text" id="type" value={activeCustomer?.__t} className="form-control" disabled />
                                                </div>
                                                <div className="col-6 col-md-3">
                                                    <label htmlFor="prescribeBy" className="form-label mb-0">
                                                        Prescribed By
                                                    </label>
                                                    <input type="text" id="prescribeBy" value={activeCustomer.prescribedBy} className="form-control bg-white" disabled />
                                                </div>
                                            </div>
                                            ...
                                            <table className="table table-sm text-center" style={{ border: "1px solid lightgray", width: "100%" }}>
                                                <thead>
                                                    <tr>
                                                        <td>Psm(R)</td>
