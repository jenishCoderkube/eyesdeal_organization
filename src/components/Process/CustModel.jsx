            ...
            >
                <div className="modal-content border-0">
                    <div className="modal-header border-bottom pb-2">
                        ...
                        <button type="button" className="btn-close small" onClick={closeCustModal} aria-label="Close"></button>
                    </div>
                                ...
                                <div className="px-3 pb-4">
                                    ...
                                    <div className="row g-3 mb-3">
                                        <div className="col-6 col-md-3">
                                            ...
                                            <input type="text" id="date" className="form-control bg-white" disabled />
                                        </div>
                                        <div className="col-6 col-md-3">
                                        ...
                                        <div className="col-6 col-md-3">
                                            ...
                                            <input type="text" id="prescribeBy" className="form-control bg-white" disabled />
                                        </div>
                                    </div>
